...
class ProcedureController extends Controller
{
    ...
    {
        $procedures = Procedure::with('formTemplate', 'process')->orderBy('created_at', 'DESC')->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            "process_id" => "required|exists:procedure_processes,id",
        ...
        $model->process_id = $request->process_id;
