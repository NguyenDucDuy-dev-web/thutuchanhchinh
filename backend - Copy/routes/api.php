...
use App\Http\Controllers\Admin\MailUserStatusController;
use App\Http\Controllers\Admin\NewsController;
use App\Http\Controllers\Admin\ProcedureController;
use App\Http\Controllers\Admin\ProcedureProcessController;
use App\Http\Controllers\Admin\ProcedureSubmissionController;
use App\Http\Controllers\Admin\ProcedureSubmissionPdfController;
...
Route::get('procedure/submission/{id}/pdf', [ProcedureSubmissionPdfController::class, 'generatePdf']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::prefix('procedure')->group(function () {
        ...
        Route::prefix('form-templates')->group(function () {
            ...
            Route::get('/getformtemplates', [FormTemplateController::class, 'getform_template']);
        ...
        Route::prefix('process')->group(function () {
            Route::get('/', [ProcedureProcessController::class, 'index']);
            Route::post('/', [ProcedureProcessController::class, 'store']);
            // Route::get('/{id}', [ProcedureSubmissionController::class, 'show']);
            Route::put('/{id}', [ProcedureProcessController::class, 'update']);
            Route::delete('/{id}', [ProcedureProcessController::class, 'destroy']);
        });
    });
    ...
    Route::prefix('mailUserstatus')->group(function () {
        Route::get('/{mailTemplateId}', [MailUserStatusController::class, 'getUsersWithStatus']);
        Route::post('/send-bulk-mail', [MailUserStatusController::class, 'sendBulkMail']);
        Route::post('/send-single-mail', [MailUserStatusController::class, 'sendSingleMail']);
        Route::post('/reset-mail-status', [MailUserStatusController::class, 'resetMailStatus']);
        // Route::post('/', [MailTemplateController::class, 'store']);
        // Route::get('/{id}', [ProcedureSubmissionController::class, 'show']);
        // Route::put('/{id}', [MailTemplateController::class, 'update']);
        // Route::delete('/{id}', [ProcedureProcessController::class, 'destroy']);
